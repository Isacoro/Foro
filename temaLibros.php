...
try{
    ...
    $sentencia = $bd->prepare('SELECT u.nombre, id_mensaje, id_tema, titulo, mensaje  FROM mensaje m INNER JOIN usuario u on m.id_usuario = u.id_usuario WHERE id_tema = "4"');
    $sentencia->execute();
